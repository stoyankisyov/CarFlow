...
public class EngineConfigurationsController(IEngineConfigurationService engineConfigurationService) : Controller
{
    ...
    {
        var engineConfigurationViewModel = (await engineConfigurationService.GetAsync(id)).ToViewModel();
